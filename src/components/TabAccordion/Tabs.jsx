        ...
        {items.map((item, i) => (
          <button
            ...
            className="
              ...
              font-pp font-medium text-[15px] text-text-muted
        ...
        {items.map((item, i) => (
          <div
            ...
            className={clsx(
              ...
              "[&_p]:font-rb [&_p]:text-[15px] [&_p]:leading-[1.75] [&_p]:text-content-body [&_p]:mb-3",
              "[&_ul]:pl-5 [&_ul]:mt-2",
              "[&_li]:font-rb [&_li]:text-[15px] [&_li]:leading-[1.75] [&_li]:text-content-body [&_li]:list-disc [&_li]:mb-1",
              activeIndex === i
